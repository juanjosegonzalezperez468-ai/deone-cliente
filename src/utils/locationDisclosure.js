...
// se recoge y para qué se usa. Mismo patrón que en deone-conductor.
...
function mostrarAvisoUbicacion() {
  return new Promise((resolve) => {
    Alert.alert(
      'Uso de tu ubicación',
      'Deone recopila datos de tu ubicación para detectar tu posición al ' +
        'solicitar un servicio, cotizar tu viaje y mostrarte la distancia ' +
        'al conductor mientras usas la app.',
      [
 ...
 * botón GPS) para preguntar de nuevo. Varias llamadas simultáneas comparten
 * una sola solicitud para no duplicar el aviso.
 */
